...
namespace VamBooru.Tests.Controllers
{
	public class PostControllerTests
	{
		...
		public async Task Browse_Defaults()
		{
			...
			repository
				.Setup(mock => mock.BrowsePostsAsync(PostSortBy.Created, PostSortDirection.Down, PostedSince.Forever, 0, 16, null, null, It.Is<DateTimeOffset>(d => d <= DateTimeOffset.UtcNow)))
				.ReturnsAsync(new[]
				{
					new Post
					{
